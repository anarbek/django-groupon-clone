...
DATABASES = {
    'default': {
        ...
        'NAME': 'groupon.db',                      # Or path to database file if using sqlite3.
...
#PATH_ADMINMEDIA = '/Library/Python/2.7/site-packages/django/contrib/admin/media'
#PATH_MEDIA = MEDIA_ROOT
...
SECRET_KEY = '+4e+neqqq#wg#*(q8udt@$d(vj0k(pmt@#c(w8485^-ut@gb#v'
...
WEBSITE_TITLE = "Open source Groupon clone"
...
try:
    ...
    logging.warning('Unable to load local settings, sensitive settings might not be available.')
